...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <?= HTML::style('dist/css/built.min.css') ?>

    <!-- Custom Google Web Font -->
    <link href='http://fonts.googleapis.com/css?family=Lato:100,300,400,700,900,100italic,300italic,400italic,700italic,900italic' rel='stylesheet' type='text/css'>

    <!-- Add custom CSS here -->
    <?= HTML::style('dist/css/landing-page.css') ?>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <?= HTML::link('/', 'James T.I.', array('class' => 'navbar-brand')) ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="<?= URL::to('dist/img/ipad.png') ?>" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="<?= URL::to('dist/img/doge.png') ?>" alt="">
                </div>
            </div>
    ...
    <div class="content-section-a">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="<?= URL::to('dist/img/phones.png') ?>" alt="">
                </div>
            </div>
    ...
    <!-- JavaScript -->
    <?= HTML::script('dist/js/built.min.js') ?>
